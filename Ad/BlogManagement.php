...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<img src="../images/' . $row["blogimage"] . '" alt="' . $row["blogtitle"] . '">';
        echo '<p><strong>Author:</strong> ' . $row["blogauthor"] . '</p>';
        echo '<p><strong>Date:</strong> ' . $row["blogdate"] . '</p>';
        echo '<p><strong>Content:</strong> ' . $row["blogcontent"] . '</p>';
        echo '<p><strong>One Liner:</strong> Rs.' . $row["blogoneliner"] . '</p>';
        echo '<a href="../php/deleteblog.php?item_id='.$row["id"].'">Delete</a>';
        echo '</div>';
    }
} else {

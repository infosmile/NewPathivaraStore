document.addEventListener('DOMContentLoaded', function () {
 ...
 function fetchDataAndDisplayAlert() {
            ...
            xhr.open('GET', 'http://azamsheikh.com/InfoSmile/NewPathivara/php/getPageContent.php', true);
         ...
         function putdataonpage(datastring)
         {
            ...
            //testimonial-2-job
            document.getElementById("testimonial-2-job").innerHTML=getValueByName("testimonial-1-job", jsonData);
            ...
            //trendingList
            var trendingListJson = getValueByName("trendingCategories", jsonData);
            document.getElementById("trendingListContainer").innerHTML = maketrendingList(trendingListJson);

            //trendingImages
            document.getElementById("trendingImage1").src=getValueByName("trendingImage1", jsonData);
            document.getElementById("trendingImage2").src=getValueByName("trendingImage2", jsonData);
            document.getElementById("trendingImage3").src=getValueByName("trendingImage3", jsonData);
            document.getElementById("trendingImage4").src=getValueByName("trendingImage4", jsonData);
...
function fetchDataAndDisplayMattressProducts() {
            ...
            xhr.open('GET', 'http://azamsheikh.com/InfoSmile/NewPathivara/php/getMattressProducts.php', true);
...
document.getElementById("mattressProducts").innerHTML = htmlString +'</div>';
         ...
         function fetchDataAndDisplayCurtainsProducts() {
            ...
            xhr.open('GET', 'http://azamsheikh.com/InfoSmile/NewPathivara/php/getCurtainsProducts.php', true);
...
document.getElementById("curtainProducts").innerHTML = htmlString2+'</div>';
            ...
            xhr.open('GET', 'http://azamsheikh.com/InfoSmile/NewPathivara/php/getOtherProducts.php', true);
...
function fetchDataAndDisplayFeaturedProducts() {
            ...
            xhr.open('GET', 'http://azamsheikh.com/InfoSmile/NewPathivara/php/getFeaturedProducts.php', true);
